...
export const CATEGORY_PAGES: CategoryPage[] = [
  {
    ...
    metaDescription:
      'Peluches Pokémon originales de alta calidad. Mew, Pikachu, Snorlax y más. Recojo gratis en nuestros puntos de recojo en Dra. Mew Store.',
  },
  {
    slug: 'figuras',
    name: 'Figuras',
    ...
    metaDescription:
      'Figuras Pokémon coleccionables de alta gama. Charizard, Bulbasaur, Gengar y más. Recojo gratis en nuestros puntos de recojo.',
  },
  {
    slug: 'cartas',
    name: 'Cartas',
  ...
  },
  {
    ...
    metaDescription:
      'Ropa Pokémon: camisetas, gorras y accesorios con diseños originales. Recojo gratis en nuestros puntos de recojo.',
  },
  {
    slug: 'accesorios',
    name: 'Accesorios',
